...
h2. Start all at once with thor-task

You can use <code>thor application:run_autotests</code> to start the spork-server and autotest. 
The shortest way to jump into *continuos testing* 

h2. Layout and Templates
...
* visit "Demo Page":http://cba.iboard.cc/pages/4dbec030daf9853b30000036
