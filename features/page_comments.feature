Feature: Comments on pages
  ...
  Background:
    ...
    And the following default pages
      | title  | body                 | show_in_menu | allow_public_comments | allow_comments | is_draft | is_template |
      | Page 1 | Lorem ipsum          | true         | true                  | true           | false    | false       |
      | Page 2 | Lirum Opsim          | false        | true                  | true           | false    | false       |
